...
namespace PictureLibraryModel.Tests.ServicesTests
{
    public class WindowsFileSystemServiceTests
    {
        ...
        [Fact]
        public void Move_ShouldThrowArgumentException_WhenDestinationPathIsWhiteSpace()
        {
            var fileName = "testFile.jpg";
            var sourceDirectory = "Tests\\Folder1\\";
            var destinationDirectory = "    ";
        ...
        [Fact]
        public void Move_ShouldThrowFileNotFoundException_WhenFileDoesntExist()
        {
            var fileName = "testFile.jpg";
            var sourceDirectory = "Tests\\Folder1\\";
            var destinationDirectory = "Tests\\Folder2\\";
            ...
            Assert.Throws<FileNotFoundException>(() => service.Move(imageFile, destinationDirectory));

            CleanupFiles();
        }

        [Fact]
        public void Move_ShouldThrowDirectoryNotFoundException_WhenFolderDoesntExist()
        {
            var folderName = "Folder";
            var sourceDirectory = "Tests/Folder1/";
            var destinationDirectory = "Tests/Folder2/";
        ...
        [Fact]
        public void GetSubFolders_ShouldThrowArgumentException_WhenTopDirectoryIsEmpty()
        {
            var topDirectory = "";
